...
We accept contributions via Pull Requests on [Github](https://github.com/liviasoft/logistics-dev-platform).
...
1. Search the [issue tracker](https://github.com/liviasoft/logistics-dev-platform/issues) to see if it’s already been reported.
2. If not, [open a new issue](https://github.com/liviasoft/logistics-dev-platform/issues/new/choose) and provide:
   - A descriptive title.
...
6. [Open a pull request](https://github.com/liviasoft/logistics-dev-platform/compare) with:
   - A clear title.
...
- [Open an issue](https://github.com/liviasoft/logistics-dev-platform/issues/new/choose)
